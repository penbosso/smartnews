                ...
                $article = $pageScraper->getArticle("");  
                ?>
            <div class="columns">
                ...
                <div class="entry-container box">
                    <div class="post-title author-image-on">
                        ...
                        <div class="post-meta">
                            <ul>
                                <li>
                                    <time class="entry-date updated" datetime="Tuesday, Jul 03">Tuesday, Jul 03</time>
                                </li>
                                <li class="divider">/</li>
                                <li>:: <a target="_blank" href="https://www.myjoyonline.com">My Joy Online</a> ::</li>
                            </ul>
                        </div>
                    </div>
                    <div class="entry-content entry-content2" lang="en">
                        ...
                        <footer class="entry-meta clearfix">
                            <ul class="post-tags clearfix">
                                <li><a class="cat-item-link" data-href="agency-2" rel="tag">My Joy Online</a></li>
